	...
	(
		...
		return (
			...
			>
				<div
					className={cn(
						'relative min-h-[40px] rounded-md border border-input text-sm transition-all duration-300 ease-in-out hover:border-primary has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-50',
						{
